...
export const RATIOS = [
  ...
  { id:'ccn', nom:'Compras y gastos sobre cifra de negocios', u:'%', d:1, cola:'alta', p:1.2, f:F_INE,
    calc: x => (x.gastos / x.cn) * 100,
  ...
  { id:'cno', nom:'Cifra de negocios por persona ocupada', u:' k€', d:0, cola:'baja', p:1.0, f:F_INE,
    calc: x => x.emp > 0 ? x.cn / x.emp / 1000 : null,
    txt:'Ventas entre personal ocupado. Facturar claramente menos por cabeza que tu actividad describe una estructura que declara menos ingreso del que su plantilla puede generar. Ojo si el socio administrador no está contado, porque el denominador queda corto y el ratio sale inflado.' },
...
export const CAMPOS = [
  { id:'cn',     l:'Importe neto de la cifra de negocios', c:'70', ancho:true,
    pista:'La casilla de ventas de tu cuenta de resultados del último ejercicio cerrado.' },
  { id:'gastos', l:'Compras y otros gastos de explotación', c:'60 + 62',
    pista:'Aprovisionamientos más servicios exteriores. Sin incluir nóminas.' },
  { id:'pers',   l:'Gastos de personal', c:'64',
    pista:'Sueldos y seguridad social a cargo de la empresa.' },
  { id:'emp',    l:'Personal ocupado medio',
    pista:'Incluye al socio que trabaja, esté o no en nómina.' },
  { id:'ivasop', l:'IVA soportado deducido en el año', c:'472',
    pista:'Suma de las cuotas deducidas en los cuatro modelos 303.' },
]
