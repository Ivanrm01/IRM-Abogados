...
-- Tabla de honorarios (data/honorarios-schema.sql). Si aún no la has creado, borra esta línea.
alter table crm_honorarios  enable row level security;

-- Comprobación: todas deben aparecer con rowsecurity = true
...
-- alter table crm_honorarios  disable row level security;
