    ...
    <>
          ...
          {[
            ...
            <div key={c.href} className={styles.heroCard}>
              <div className={styles.heroCardIcon}>
                {c.icon === 'fiscal' && <Gavel size={24} strokeWidth={1.5} color="#B8975A" />}
      ...
      <section className={styles.ctaSection}>
        ...
        <div className={styles.ctaBtns}>
          ...
          <TrackedLink ubicacion="home" href="tel:+34614149465" className="btn-outline-navy">HABLAR CON UN EXPERTO</TrackedLink>
        </div>
      </section>
    </>
  )
