    ...
    <>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroStats}>
          {[['2','Sedes en España'],['100%','Especialización fiscal'],['24h','Tiempo de respuesta'],['0€','Estudio expediente']].map(([n,l]) => (
      ...
      <section className={`section ${styles.sedes}`}>
        ...
        <div className={styles.sedesGrid}>
          {[
            { city:'Madrid', tag:'Sede principal', addr:'C/ José Ortega y Gasset, 84 — 2º C · 28006 Madrid', maps:'https://www.google.com/maps/place/?q=place_id:ChIJKUiFqZgpQg0RV-I-ac1bG4s' },
            { city:'Castellón', tag:'Sede Levante', addr:'C/ En Medio, 22 — 6º · 12001 Castellón de la Plana', maps:'https://www.google.com/maps/place/?q=place_id:ChIJtwgvmzv_Xw0RswyxvCi2JAs' },
          ].map(s => (
            <div key={s.city} className={styles.sedeCard}>
              ...
              <TrackedLink ubicacion="sobre_nosotros" href="tel:+34614149465" className={styles.sedePhone}>+34 614 149 465</TrackedLink>
      ...
      <section className={styles.ctaSection}>
        ...
        <div className={styles.ctaBtns}>
          ...
          <TrackedLink ubicacion="sobre_nosotros" href="tel:+34614149465" className="btn-outline-navy">HABLAR CON UN EXPERTO</TrackedLink>
        </div>
      </section>
    </>
  )
