...
export default function HojaEncargo() {
  ...
  return (
    <div style={{ display:'grid', gridTemplateColumns:'minmax(380px, 440px) 1fr', gap:'0', height:'100%' }}>
      {/* FORMULARIO */}
      <div style={{ padding:'24px 26px', overflowY:'auto', borderRight:'1px solid #e5e7eb', fontFamily:'Outfit, sans-serif' }}>
