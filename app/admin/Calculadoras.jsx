...
export default function Calculadoras() {
  ...
  const generarPDF = async () => {
    ...
    try {
      ...
      // Cargar el logo oficial (public/logo-irm.png)
      ...
      if (logoData) {
        const lh=15, lw=lh*logoRatio
        try { doc.addImage(logoData,'PNG',M,11.5,lw,lh) } catch(e){ doc.setFont('times','bold'); doc.setFontSize(26); doc.setTextColor(255,255,255); doc.text('IRM', M, 22) }
      } else {
