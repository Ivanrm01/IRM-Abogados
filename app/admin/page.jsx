      ...
      <div className={styles.main}>
        <div className={styles.topbar}>
          <div className={styles.topbarTitle}>
            {view==='crm'?'CRM legal':view==='list'?'Artículos del blog':view==='encargos'?'Hojas de encargo':view==='calculadoras'?'Calculadoras de garantías':view==='plazos'?'Plazos y vencimientos':post.id?'Editar artículo':'Nuevo artículo'}
          </div>
        ...
        {/* CRM VIEW */}
        {view==='crm'&&(
          <div className={styles.toolPane} style={{flex:1,minHeight:0,overflow:'hidden'}}>
