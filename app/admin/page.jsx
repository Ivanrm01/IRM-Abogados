      ...
      <div className={styles.main}>
        <div className={styles.topbar}>
          <div className={styles.topbarTitle}>
            {view==='list'?'Artículos del blog':view==='encargos'?'Hojas de encargo':view==='calculadoras'?'Calculadoras de garantías':view==='plazos'?'Plazos y vencimientos':post.id?'Editar artículo':'Nuevo artículo'}
          </div>
