      ...
      <section className={styles.content}>
        <div className={styles.contentInner}>
          ...
          <div className={styles.block}>
            ...
            <h3>2.4 Registro de consentimientos de cookies</h3>
            <ul>
              <li><strong>Datos:</strong> Identificador aleatorio generado por el navegador, fecha y hora, finalidades aceptadas o rechazadas, opción pulsada, página, texto informativo mostrado y huellas cifradas e irreversibles de la dirección IP y del navegador. No se guarda la dirección IP.</li>
              <li><strong>Finalidad:</strong> Acreditar que el consentimiento para el uso de cookies se obtuvo de forma válida.</li>
              <li><strong>Base jurídica:</strong> Cumplimiento de una obligación legal (arts. 6.1.c y 7.1 RGPD).</li>
              <li><strong>Conservación:</strong> 4 años desde cada decisión; después se elimina automáticamente.</li>
            </ul>
          </div>
