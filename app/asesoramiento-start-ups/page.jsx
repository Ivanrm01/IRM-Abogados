  ...
  return (
    <>
      ...
      <section className={styles.serviciosSection}>
        ...
        <p className={styles.heroDesc}>Estos son los servicios concretos que más demandan nuestros clientes del ecosistema Start-Up. Todos están diseñados pensando en la velocidad, la escalabilidad y la seguridad jurídica.</p>
        <div className={styles.fasesGrid}>
