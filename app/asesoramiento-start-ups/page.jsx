...
const faqs = [
  { q:'¿Qué forma jurídica es mejor para una Start-Up?', a:'Para la mayoría de Start-Ups en España, la Sociedad Limitada (SL) es la opción más adecuada por su flexibilidad, bajo capital mínimo (3.000€ o 1€ si optáis por la SL de Formación Sucesiva) y menor coste de constitución. La SA puede tener sentido si desde el inicio prevéis entrada de inversores institucionales o cotización futura. Lo importante es elegir bien los estatutos y el pacto de socios, más que la forma jurídica en sí.' },
  { q:'¿Qué debe incluir un buen pacto de socios?', a:'Un pacto de socios completo debe cubrir: régimen de vesting (qué pasa si un socio se va antes), cláusulas drag-along y tag-along (para facilitar ventas futuras), derecho de tanteo y retracto (control sobre quién puede entrar en el capital), cláusulas good/bad leaver, acuerdos sobre toma de decisiones y desbloqueo de bloqueos, y cómo se distribuyen los beneficios. Sin un buen pacto de socios, cualquier conflicto puede paralizar o destruir la Start-Up.' },
  { q:'¿Cuándo es el momento ideal para hacer la due diligence fiscal preventiva?', a:'Lo ideal es hacerla antes de iniciar conversaciones formales con inversores, normalmente entre 6 y 12 meses antes de una ronda. Así tienes tiempo de identificar y resolver cualquier incidencia sin presión. Si la hacéis cuando ya estáis en negociación y aparece un problema, os pone en una posición de debilidad negociadora o puede incluso hacer caer la operación.' },
  { q:'¿Qué es un ESOP y por qué necesita mi Start-Up uno?', a:'Un ESOP (Employee Stock Option Plan) es un plan que permite a los empleados adquirir participaciones o acciones de la empresa a un precio predeterminado. Es una herramienta clave para retener y atraer talento cuando no puedes competir en salario con las grandes empresas. Su diseño fiscal correcto es fundamental: si se estructura mal, puede generar una factura fiscal inesperada tanto para la empresa como para el empleado.' },
  { q:'¿Qué ventajas fiscales tienen los inversores en Start-Ups españolas?', a:'Los business angels que invierten en Start-Ups españolas pueden deducirse el 50% de la inversión en el IRPF (con una base máxima de 100.000€ anuales). Además, si la Start-Up es de nueva creación e innovadora, pueden aplicar exenciones sobre las ganancias obtenidas al vender. También existe el régimen de Entidades de Capital-Riesgo (ECR) con ventajas específicas para los fondos de inversión.' },
  { q:'¿Necesito un holding para mi Start-Up?', a:'Depende del momento y los objetivos. Una estructura holding tiene sentido cuando planeas tener varias sociedades participadas, cuando quieres optimizar la fiscalidad de los dividendos o cuando vas a expandirte internacionalmente. En early stage suele ser prematuro y añade complejidad innecesaria. Lo evaluamos caso a caso en la primera consulta.' },
]
