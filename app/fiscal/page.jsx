...
const serviciosFiscales = [
  { n:'01', t:'IRPF — Personas físicas', d:'Declaraciones de renta de cualquier complejidad. Actividades económicas, alquileres, ganancias patrimoniales y rendimientos del capital.', items:['Declaración de la Renta anual','Estimación directa y módulos','Ganancias y pérdidas patrimoniales','Rendimientos del capital mobiliario','Deducciones autonómicas y estatales'] },
  { n:'02', t:'Impuesto sobre Sociedades', d:'Gestión integral del IS para empresas. Optimización del resultado fiscal, deducciones y cumplimiento de todas las obligaciones.', items:['Presentación del modelo 200','Pagos fraccionados — modelo 202','Deducciones por I+D e inversión','Ajustes extracontables','Grupos fiscales y consolidación'] },
  { n:'03', t:'IVA e impuestos indirectos', d:'Liquidaciones periódicas, gestión de deducciones, operaciones intracomunitarias y cumplimiento de todas las obligaciones formales.', items:['Modelos 303, 390 y 349','Operaciones intracomunitarias','Prorrata y sectores diferenciados','Devoluciones de IVA','Regímenes especiales'] },
...
const faqs = [
  ...
  { q:'¿Qué hago si recibo una carta o requerimiento de Hacienda?', a:'Lo más importante es no ignorarla y actuar dentro del plazo indicado (generalmente 10 días hábiles). Antes de responder conviene analizar qué pide exactamente la AEAT. Una respuesta incorrecta o incompleta puede agravar la situación.' },
  { q:'¿Puedo reducir el Impuesto sobre Sociedades legalmente?', a:'Sí. Existen numerosas deducciones que muchas empresas no aprovechan: I+D+i, inversión en activos nuevos, creación de empleo, donaciones, reserva de capitalización, etc. Una planificación adecuada puede reducir significativamente la carga tributaria.' },
  { q:'¿Es posible recurrir una sanción de la AEAT?', a:'Sí. Las sanciones son recurribles mediante recurso de reposición (en el propio órgano) o reclamación económico-administrativa ante el TEAR. Si la sanción no tiene suficiente fundamento legal, puede reducirse o anularse.' },
  { q:'¿Cómo tributan las criptomonedas en España?', a:'Las ganancias o pérdidas de criptomonedas se integran en la base del ahorro del IRPF y tributan al tipo del ahorro (19%-28%). Las obligaciones informativas también han aumentado: modelo 721 para criptoactivos en el extranjero.' },
]
