  ...
  return (
    <>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroText}>
          ...
          <p className={styles.heroDesc}>
            ...
            con estadística pública del INE y de la propia Agencia Tributaria. Cinco cifras de tu
        ...
        <div className={styles.heroCards}>
          {[
            ...
            { l:'En un minuto', t:'5 cifras', d:'Las que tienes a mano en la cuenta de resultados. Sin buscar nada.' },
      ...
      <section className={styles.form}>
        ...
        <div className={styles.eyebrow} style={{ marginTop: 48 }}>02 · Copia cinco cifras del ejercicio cerrado</div>
        <div className={styles.ficha}>
          <div className={styles.grid}>
            {CAMPOS.map(c => (
              <div key={c.id} className={`${styles.campo} ${c.ancho ? styles.ancho : ''}`}>
                <label htmlFor={c.id}>
                  {c.l}
