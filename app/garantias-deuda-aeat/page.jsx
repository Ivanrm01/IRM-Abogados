...
const herramientas = [
  { n:'01', sub:'Herramienta 01', t:'Aplazamiento de deuda', d:'Mueve el pago de tu deuda a una fecha futura. La AEAT acepta aplazar cuando demuestras que tu situación económica no te permite afrontarla sin poner en riesgo tu actividad o patrimonio.', cuando:'Cuando necesitas tiempo para generar liquidez pero la deuda no está en disputa. Ideal para autónomos y empresas con tesorería ajustada.' },
