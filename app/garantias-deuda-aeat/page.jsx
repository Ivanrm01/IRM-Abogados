...
const herramientas = [
  ...
  { n:'02', t:'Fraccionamiento de pago', d:'Divide la deuda en cuotas periódicas. A diferencia del aplazamiento, el fraccionamiento distribuye el importe en mensualidades adaptando el pago a tu capacidad económica real.', cuando:'Cuando puedes pagar pero no de una sola vez. Permite mantener tu actividad y cumplir con Hacienda de forma escalonada.' },
  { n:'03', t:'Suspensión de la deuda', d:'Paraliza temporalmente la ejecución de la deuda mientras se tramita un recurso o reclamación. Detiene embargos y actuaciones ejecutivas mientras discutes la legalidad o el importe.', cuando:'Cuando crees que la deuda es incorrecta, excesiva o ilegal. Se usa junto a recursos de reposición o reclamaciones económico-administrativas.' },
