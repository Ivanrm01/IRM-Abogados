  ...
  return (
    <>
      ...
      <section className={styles.diferencial}>
        ...
        ﻿{[
          { icon: '🛡', t: 'Especialización en derecho fiscal', d: 'No somos un despacho de abogados generalista.' },
          ...
          { icon: '💲', t: 'Honorarios transparentes desde el inicio', d: 'Conoces el coste exacto antes de empezar. Sin sorpresas.' },
      ...
      <div className={styles.difRight}>
        <div className={styles.riskBox}>
          <div className={styles.riskTitle}>Sin asesoramiento especializado, te arriesgas a:</div>
            <ul className={styles.riskList}>
              {['Embargo de cuentas bancarias','Embargo de nómina o pensión','Anotación de embargo sobre inmuebles','Recargos del 5%, 10% o 20% sobre la deuda original','Intereses de demora'].map(i => (
      ...
      <section className={styles.cta}>
        <div className={styles.ctaLeft}>
          ...
          <div className={styles.ctaBtns}>
            ...
            <TrackedLink ubicacion="garantias_aeat" href="tel:+34614149465" className="btn-outline-navy">HABLAR CON UN EXPERTO</TrackedLink>
          </div>
        </div>
        <div className={styles.ctaRight}>
          {[{icon:'📞',label:'Teléfono',value:'+34 614 149 465',href:'tel:+34614149465'},{icon:'✉️',label:'Email',value:'correo@irmabogados.es',href:'mailto:correo@irmabogados.es'},{icon:'📍',label:'Sedes',value:'Madrid · Castellón · Online',href:'/contacto'}].map(c => (
            <div key={c.label} className={styles.ctaContactRow}>
              ...
              <div><div className={styles.ctaLabel}>{c.label}</div><TrackedLink ubicacion="garantias_aeat" href={c.href} className={styles.ctaValue}>{c.value}</TrackedLink></div>
            </div>
          ))}
