      ...
      <section className={styles.content}>
        <div className={styles.contentInner}>
          ...
          <div className={styles.block}>
            ...
            <div className={styles.ckTable}>
              ...
              <div className={styles.ckRow}>
                ...
                <span>Almacena la decisión que usted toma en el panel de cookies (qué finalidades acepta o rechaza), la fecha en que la tomó y un identificador aleatorio, para no volver a preguntárselo en cada página y para poder acreditar el consentimiento.</span>
                <span>12 meses</span>
                <span>Propia</span>
              </div>
            </div>
          ...
          <div className={styles.block}>
            ...
            <p><strong>Registro de su decisión.</strong> Para poder demostrar que el consentimiento se prestó válidamente (artículo 7.1 RGPD), cada vez que acepta, rechaza o modifica su elección anotamos en nuestro servidor: el identificador aleatorio de la cookie <code>irm_consent</code>, la fecha y hora, las finalidades aceptadas y rechazadas, la opción que pulsó, la página en la que estaba, el texto informativo que se le mostró y una huella cifrada e irreversible de su dirección IP y de su navegador. No guardamos su dirección IP ni ningún otro dato que le identifique directamente. Este registro se conserva durante <strong>4 años</strong> (los 12 meses de vigencia del consentimiento más el plazo de prescripción de las infracciones) y después se elimina automáticamente.</p>
