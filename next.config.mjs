...
const nextConfig = {
    images: {
    remotePatterns: [
      { protocol: 'https', hostname: 'www.irmabogadosasesores.com' },
      { protocol: 'https', hostname: 'irmabogadosasesores.com' },
  ...
  async redirects() {
    return [
      ...
      // ===== Páginas antiguas de Wix que daban error 404 en Search Console =====
      // Antigua página "Inmobiliario"
      { source: '/administradores-fincas-castellon', destination: '/servicios', permanent: true },
      { source: '/administradores-fincas-castellón', destination: '/servicios', permanent: true },
      { source: '/administradores-fincas-castell%C3%B3n', destination: '/servicios', permanent: true },
      // Página duplicada que creó Wix ("Copia de Servicios")
      { source: '/copia-de-servicios', destination: '/servicios', permanent: true },
      // Antigua dirección de la página de no residentes (ahora está dentro de /en/)
      { source: '/modelo-210-non-resident-tax', destination: '/en/modelo-210-non-resident-tax', permanent: true },
      // Dirección sin sentido que Google intentó visitar: https://www.irmabogadosasesores.com/*
      { source: '/\\*', destination: '/', permanent: true },
      // Para añadir otra, copia esta línea, quita las dos barras del principio y cambia las rutas:
      // { source: '/ruta-antigua-sin-dominio', destination: '/pagina-nueva', permanent: true },
